...
if( ! defined( 'EDUCATION_ZONE_THEME_VERSION' ) ) define( 'EDUCATION_ZONE_THEME_VERSION', $theme_data->get( 'Version' ) );
if( ! defined( 'EDUCATION_ZONE_THEME_NAME' ) ) define( 'EDUCATION_ZONE_THEME_NAME', $theme_data->get( 'Name' ) );
if( ! defined( 'EDUCATION_ZONE_THEME_TEXTDOMAIN' ) ) define( 'EDUCATION_ZONE_THEME_TEXTDOMAIN', $theme_data->get( 'TextDomain' ) );
        ...
        <div class="welcome-message notice notice-info">
            <div class="notice-wrapper">
                <div class="notice-text">
                    ...
                    <p><?php printf( __( '%1$s is now installed and ready to use. Click below to see theme documentation, plugins to install and other details to get started.', 'education-zone' ), $name ) ; ?></p>
...
if( ! function_exists( 'education_zone_restore_admin_notice' ) ) :
/**
 * Restoring admin notice on theme switch
 */
function education_zone_restore_admin_notice(){
    update_option( 'education_zone_admin_notice', false );
}
endif;
add_action( 'after_switch_theme', 'education_zone_restore_admin_notice' );
